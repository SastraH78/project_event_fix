                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="form-group border_bottom pb_30">
                                                        ...
                                                        <p class="mt-2 d-block fs-14 mb-3">See how your name appears on the event page</p>
                                                    ...
                                                    <div class="form-group border_bottom pt_30 pb_30">
                                                        ...
                                                        <p class="mt-2 d-block fs-14 mb-3">Choosing relevant categories helps to improve the discoverability of your event</p>
                                                        <select class="selectpicker" data-size="5" title="Select category" data-live-search="true">
                                                        ...
                                                        <div class="row g-2">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row g-2">
                                                                    <div class="col-md-6">
                                                                        <div class="clock-icon">
                                                                            <label class="form-label mt-3 fs-6">Time Start</label>
                                                                            <input class="form-control h_50" type="time" placeholder="" value="" style="background:green">
                                                                            <!-- <select class="selectpicker" data-size="5" data-live-search="true">
                                                                                <option value="00:00">12:00 AM</option>
                                                                                <option value="00:15">12:15 AM</option>
                                                                                <option value="00:30">12:30 AM</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label class="form-label mt-3 fs-6">Time End</label>
                                                                        <!-- ubah class di dalam select dari selectpicker-->
                                                                        <input class="form-control h_50" type="time" placeholder="" value="" style="background:green">
                                                                        <!-- <select class="selectpicker" data-size="5" data-live-search="true">
                                                    ...
                                                    <div class="form-group pt_30 pb_30">
                                                        ...
                                                        <p class="mt-2 fs-14 d-block mb-3 pe_right">Upload colorful and vibrant images as the banner for your event! See how beautiful images help your event details page</p>
                                                        <div class="content-holder mt-4">
                                                            <div class="default-event-thumb">
                                                                ...
                                                                <img src="<?= base_url() ?>assets/images/banners/custom-img.jpg" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group border_bottom pb_30">
                                                                ...
                                                                <div class="row g-4">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group mt-1">
                                                                            <label class="form-label fs-6">Location Type</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group mt-1">
                                                                            <label class="form-label fs-6">Latitude</label>
                                                                            <input class="form-control h_50" type="text" placeholder="" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group mt-1">
                                                                            <label class="form-label fs-6">Longitude</label>
                                                                            <input class="form-control h_50" type="text" placeholder="" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group main-form mt-1">
                                                                            ...
                                                                            <!-- ubah class yg didalam select dari selectpicker form-control h_50 -->
                                                                            <select class="selectpicker" data-size="5" title="Nothing selected" data-live-search="true">
                                                                                <option selected="" disabled="">
                                                                                    -- Country --
                                                                                </option>
                                                                    ...
                                                                    <!-- <div class="col-md-6">
                                                                        <div class="form-group mt-1">
                                                                            ...
                                                                            <input class="form-control h_50" type="text" placeholder="State" value="">
                                                                        </div>
                                                                    </div> -->
                                                                    <div class="col-lg-6 col-md-12">
                                                                        <div class="form-group mt-1">
                                                                            <label class="form-label">City/Suburb*</label>
                                                                            <input class="form-control h_50" type="text" placeholder="City" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12">
                                                                        <div class="form-group mt-1">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="ticket-type-item-empty d-none text-center p_30">
                                                        <div class="ticket-list-icon d-inline-block">
                                                            <img src="<?= base_url() ?>assets/images/ticket.png" alt="">
                                                        </div>
