...
<script src="<?= base_url('assets/js/form/bootstrap-select.min.js') ?>"></script>
<script src="<?= base_url('assets/js/form/ckeditor.js') ?>"></script>
<script src="<?= base_url('assets/js/form/custom.js') ?>"></script>
<script src="<?= base_url('assets/js/form/night-mode.js') ?>"></script>
<script src="<?= base_url('assets/js/form/jquery-steps.min.js') ?>"></script>
<script src="<?= base_url('assets/js/form/datepicker.min.js') ?>"></script>
<script src="<?= base_url('assets/js/form/datepicker.en.js') ?>"></script>
<script>
    $('#add-event-tab').steps({
        onFinish: function() {
